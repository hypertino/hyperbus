[![Build Status](https://travis-ci.org/hypertino/hyperbus.svg)](https://travis-ci.org/hypertino/hyperbus)
...
Hyperbus is communication abstraction for the  [Hypertino services](http://hypertino.com).
